...
namespace com.pharmscription.DataAccess.Tests.TestEnvironment
{
    ...
    public class DatabaseSeeder
    {
        ...
        {
            { Seeds.Drugs, "seedDrugs.sql"},
            { Seeds.DrugStores, "seedDrugStores.sql"},
            { Seeds.DrugPrices, "seedDrugPrices.sql"}
        };

        private const string ResourceFolder = "com.pharmscription.DataAccess.Tests.";
